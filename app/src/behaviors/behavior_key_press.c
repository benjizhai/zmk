...
static int on_keymap_binding_pressed(struct zmk_behavior_binding *binding,
    ...
    const struct behavior_key_press_config *cfg = dev->config;
...
static const struct behavior_api behavior_key_press_api = {
...
#define KP_INST(n)                                                                                 \
    ...
    DEVICE_AND_API_INIT(behavior_key_press_##n, DT_INST_LABEL(n), behavior_key_press_init,         \
                        ...
                        CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &behavior_key_press_api);
